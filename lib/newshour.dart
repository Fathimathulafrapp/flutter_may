    ...
    return DefaultTabController(length: 3,
      child: Scaffold(
        appBar: AppBar(title: Row(
          children: [
            Text("News",style: TextStyle(color: Colors.black,fontSize: 19,fontWeight: FontWeight.bold),),
            Text("Hour",style: TextStyle(color: Colors.orange,fontSize: 19,fontWeight: FontWeight.bold),),
            Text("-Admin",style: TextStyle(color: Colors.black,fontSize: 19),),
          ],
     ...
     body: Center(
       ...
       child: Column(
         children: [
           ...
           SizedBox(height: 20,),
           Container( decoration: BoxDecoration(borderRadius: BorderRadius.circular(7),border: Border.all(color: Colors.black) ),
